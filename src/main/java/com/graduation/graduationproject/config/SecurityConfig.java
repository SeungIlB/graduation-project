...
import com.graduation.graduationproject.config.jwt.JwtAccessDeniedHandler;
import com.graduation.graduationproject.config.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/auth/mypage/**").authenticated() // 마이페이지 인증 필요
                .antMatchers("/images/details/**").authenticated() // 이미지 보기
